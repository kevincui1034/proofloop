"""MemoryStore — append-only JSONL + human markdown under .proofjury/.
...
exclusive lock over ``.proofjury/lock`` (flock on POSIX, msvcrt
...
class MemoryStore:
    ...
    def _exclusive_lock(self):
        """Serialize writers across processes (lock on .proofjury/lock).
